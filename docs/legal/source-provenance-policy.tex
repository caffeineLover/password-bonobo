...
The canonical \href{dependency-asset-provenance-ledger.md}{dependency and asset provenance ledger} covers resolved and
declared Python packages, GitHub Actions, document tools, and tracked repository assets. Run
\passthrough{\lstinline!uv run python -m tools.check\_provenance!} after any dependency declaration, lock, action pin,
document tool, or asset change; a passing freshness check records coverage, not legal approval for a row whose review
remains pending.
