...
\nolinkurl{gorilla.tcl}.

Suggested responsibilities:

\subsubsection{\texorpdfstring{\nolinkurl{gorilla::URLAudit}}{}}\label{gorillaurlaudit}
...
\subsubsection{\texorpdfstring{\nolinkurl{gorilla::URLAudit::URL}}{}}\label{gorillaurlauditurl}
...
\subsubsection{\texorpdfstring{\nolinkurl{gorilla::URLAudit::HTTP}}{}}\label{gorillaurlaudithttp}
...
\subsubsection{\texorpdfstring{\nolinkurl{gorilla::URLAudit::Classifier}}{}}\label{gorillaurlauditclassifier}
...
\subsubsection{\texorpdfstring{\nolinkurl{gorilla::URLAudit::Dialog}}{}}\label{gorillaurlauditdialog}
...
\subsubsection{\texorpdfstring{\nolinkurl{gorilla::URLAudit::Archive}}{}}\label{gorillaurlauditarchive}
...
\tightlist
\item
  \nolinkurl{https://example.com/login}
\item
  \nolinkurl{http://example.com/login}
\item
  \nolinkurl{example.com/login}
\item
  query strings;
\item
  fragments;
...
\tightlist
\item
  Gorilla is a Tcl/Tk application whose main UI and menus are in \nolinkurl{sources/gorilla.tcl}.
\item
  The source bundle includes Tcllib and a PasswordSafe implementation under \nolinkurl{sources/pwsafe}.
\item
  Gorilla\textquotesingle s existing UI already uses \nolinkurl{ttk::treeview} and has normal Login-menu delete
  behavior, browser-launch behavior, and File Save/Save As/Export commands that the feature should reuse rather than
  duplicate.
\item
