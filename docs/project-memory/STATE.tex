...
\item
  Task 11 is recorded by implementation commit \passthrough{\lstinline!8c2b30e!} and the reboot handoff checkpoint
  containing this state; final independent review reported no Critical or Important findings.
\end{itemize}

\subsection{Active work}\label{active-work}

Task 12 is next after consulting \nolinkurl{docs/HANDOFF.md} and, if desired, repeating the listed packaging and
security gates: add property, fuzz, corruption, and resource-safety evidence around the now-public lossless core.
